class FundoImobiliario:
    def __init__(self, codigo, segmento, cotacao_atual, ffo_yield, dividendo_yield, p_pv, valor_mercado, liquidez,
        ...
        self.dividendo_yield = dividendo_yield
        self.p_pv = p_pv
...
class Estrategia:
    def __init__(self, segmento='', cotacao_atual_minima=0,
                 ffo_yield_minimo=0, dividiend_yield_minimo=0, p_pv_minimo=0,
                 valor_mercado_minimo=0, liquedez_minima=0, qt_minima_imoveis=0,
                 valor_minimo_preco_m2=0, valor_minimo_alguel_m2=0,
